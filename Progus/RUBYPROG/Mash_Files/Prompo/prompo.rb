prompo_doc = <<prompo
	...
	is used. Where whenever a new prompo is entered the search related to the number as with all the number of others.
	So it's interesting to playing with other's choiced number, other's favorite, But I think it will be a simple i'll have.
prompo

$PROMPO_FILE_PATH = "/home/mash/Progus/RUBYPROG/Mash_Files/Prompo"
